...
namespace Recruitment_Process_Management_System.Repositories
{
    public class Document_SubmittedRepository : IDocument_SubmittedRepository
    {
        ...
        public void deleteDocument_Submitted(Document_Submitted document_Submitted)
        {
        ...
        public Document_Submitted saveDocument_Submitted(Document_Submitted document_Submitted)
        {
        ...
        public Document_Submitted updateDocument_Submitted(Document_Submitted document_Submitted)
        {
